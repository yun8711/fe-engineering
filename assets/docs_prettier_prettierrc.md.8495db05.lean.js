import{_ as s,v as n,b as l,R as a}from"./chunks/framework.8277b2e6.js";const F=JSON.parse('{"title":"","description":"","frontmatter":{"outline":"deep","prev":false,"next":false},"headers":[],"relativePath":"docs/prettier/prettierrc.md","filePath":"docs/prettier/prettierrc.md","lastUpdated":1707235725000}'),t={name:"docs/prettier/prettierrc.md"},o=a(`<h1>Prettier 配置详解</h1><p>v3.2.4（2024-02）</p><p>根据 prettier 类型定义及官方文档整理</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// @ts-check</span></span>
